...
<head>
    ...
    <!-- Title -->
    <title>Capacitaciones - Alexander Minaya</title>
    <!-- Metadatos -->
    <meta name="author" content="<?php echo AUTHOR?>">
    <meta name="description"
        content="Capacitarse constantemente radica en el hecho de que el entorno actual evoluciona a un ritmo vertiginoso. Mantenerse al día con las últimas tendencias, tecnologías y enfoques es esencial para el crecimiento personal y profesional.">
    <meta name="keywords"
...
<?php
    ...
    if(preg_match("/Edg/i",$identificador))
    {
       ...
       require_once ('view/training.php');
